...
<details>
    <summary><h3><b>프로젝트 설명 보기 </b></h3></summary>
<div markdown="1">
...
#### :eight: 실시간 챌린지를 위한 웹 소켓 구현 (진행 중)
>STOMP 프로토콜을 활용한 실시간 통신으로 잦은 통신 간 발생하는 비용 최소화
- 현재 운동 정보를 실시간으로 공유하기 위해 웹 소켓 구현 및 세션 관리
- 추후 MSA로 분리 및 Scale Out을 고려해, Kafka를 도입하여 멀티 서버에 대응
-  
